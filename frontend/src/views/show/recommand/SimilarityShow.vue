...
<div v-if="isShow">
  <br>
  <h1 class="recommend-title recommend-title ml-4 mb-4 d-flex align-center"><v-icon size="48px" color="green">mdi-account-group</v-icon>{{ userNickname }}님과 유사한 유저가 본 공연</h1> 
  <swiper class="swiper" 
